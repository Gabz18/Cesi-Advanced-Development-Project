...
public class WordDaoImpl implements WordDao {
    ...
    private static final String DROP_TABLE_STATEMENT = "drop table fileprocessor.dictionary";
    ...
    private static final String SELECT_TABLE_STATEMENT = "select count(*) from tab where tname = 'fileprocessor.dictionary'";
    ...
    public void reInitDb() {
        try {
            ...
            r.close();
            if (count > 0) {
                PreparedStatement stmt1 = conn.prepareStatement(DROP_TABLE_STATEMENT);
                stmt1.execute();
            }
